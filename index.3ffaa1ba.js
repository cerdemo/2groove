...
const f=document.querySelector('#togglePlaybackButton input[type="checkbox"]');function l(e){console.error("Could not access MIDI devices:",e)}//EVENT LISTENERS
...
setTimeout(()=>{navigator.requestMIDIAccess?navigator.requestMIDIAccess().then(e,l):console.error("WebMIDI is not supported in this browser.")},1e3))}},l):console.error("WebMIDI is not supported in this browser.");// Author: Çağrı Erdem, 2023
...
document.getElementById("changeButton").addEventListener("click",function(){P(editedArray=function(e,t=1){/**
...
// ----------------------------
//# sourceMappingURL=index.3ffaa1ba.js.map
